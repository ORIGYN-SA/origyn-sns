...
import Chart from '@pages/dashboard/top-transfers-and-burns/Chart'
...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      },
      {
        path: 'transfers',
        element: (
          <Chart type='transfers' title='All Top 25 Transfers' limit={25} />
        )
      },
      {
        path: 'burns',
        element: <Chart type='burns' title='All Top 25 Burns' limit={25} />
      },
      {
        path: 'governance',
        children: [
