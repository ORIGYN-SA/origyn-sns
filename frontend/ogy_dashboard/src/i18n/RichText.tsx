...
//   <i>…</i>  italic emphasis      <b>…</b>  bold emphasis
//   <a>…</a>  accent-colored text
...
// not handle line breaks — callers that need multi-line text split on "\n" and
// render each line through their own element.
