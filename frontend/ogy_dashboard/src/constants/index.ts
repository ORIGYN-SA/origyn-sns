...
export const ACCOUNT_ID_LEDGER_OLD_ICP = import.meta.env.VITE_ACCOUNT_ID_LEDGER_OLD_ICP;
...
if (!(APP_MODE === "production")) {
    ...
    if (!ACCOUNT_ID_LEDGER_OLD_ICP)
        console.log("No ACCOUNT_ID_LEDGER_OLD_ICP environment variable. Set ACCOUNT_ID_LEDGER_OLD_ICP environment variable.")
    else
        console.log(`ACCOUNT_ID_LEDGER_OLD_ICP=${ACCOUNT_ID_LEDGER_OLD_ICP}`)
