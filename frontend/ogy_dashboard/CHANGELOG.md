...
- Fill featured certificates and Viewer lists with visible results from later API pages when collections are hidden.
- Paginate visible results without duplicates or empty pages caused by hidden collections.
...
- Include the Gold DAO booster in reward estimates for neurons locked for five years.
- Show the booster rate, total OGY paid out, and weekly payout history on the governance dashboard.
...
- Fix certificates not loading for gold collections.

#### Added

- Add "View all" links to the Viewer category carousels.
- Show token and collection details on the certificate page.

#### Changed

- Simplify the certificate popup.

### [1.0.43] - 2026-07-24

#### Changed

- Moved the shared components and the certificate viewer to the @origyn/shared-ui library.
