            ...
            <section className="tecSection7 mx-auto flex flex-col items-center justify-center text-left">
                ...
                <div className="tecSection7-line1 px-[15px] text-left md:w-[900px] md:px-0">
                    <div className="text-[16px] leading-[26px] text-[#fff] md:text-[20px] md:leading-[30px]">
                        The Perpetual Operating System transforms the ORIGYN ecosystem, offering
                        users access to a host of products and features such as the ORIGYN
                        Management Cloud, the OGY Dashboard, and third-party DApps support.
                    </div>
                    <div className="mt-[10px] text-[16px] leading-[26px] text-[#fff] md:mt-[20px] md:text-[20px] md:leading-[30px]">
                        This collaborative space fosters innovation among developers, enhancing the
                        ORIGYN Protocol. Operating on the IC blockchain, PerpetualOS prioritizes
                        transparency and decentralization, providing a secure foundation.
                    </div>
                    <div className="mt-[10px] text-[16px] leading-[26px] text-[#fff] md:mt-[20px] md:text-[20px] md:leading-[30px]">
                        It underscores the ORIGYN Foundation's dedication to a seamless and
                        trustworthy user experience. While still in beta development, continuous
                ...
                <div className="tecSection7-line1 mt-[20px] flex w-full items-start justify-start px-[15px] pb-[40px] text-center md:mt-[50px] md:w-[900px] md:px-0 md:pb-0">
                    ...
                    >
                        Read the PerpetualOS Whitepaper
                    </div>
                </div>
            </section>
        </>
