export const BOOK_A_CALL_URL = "https://calendly.com/silviabiestro/30min";

export const PARTNERSHIPS_EMAIL = "partnerships@origyn.ch";
export const PARTNERSHIPS_MAILTO = `mailto:${PARTNERSHIPS_EMAIL}`;

export const DPP_INDEX_URL = "https://dppindex.eu/dpp-providers/origyn";
