      ...
      <div className="mt-12 grid w-full grid-cols-1 gap-4 md:grid-cols-3">
        {STEPS.map((step, i) => {
          ...
          return (
            <article
              key={step.title}
              className="flex flex-col rounded-3xl border border-[#ececec] bg-surface px-10 py-10 text-left transition-colors duration-200 hover:border-ink/20 hover:bg-black/[0.015]"
            >
              <div className="text-[clamp(2rem,4vw,2.5rem)] font-extralight leading-none tracking-[-0.04em]">
