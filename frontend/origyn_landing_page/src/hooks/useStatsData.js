...
export const useStatsData = () => {
  ...
  const isLoading = superStatsLoading || marketCapLoading || tvlLoading || tokenDataLoading || reserveDataLoading;
  const errors = [superStatsError, marketCapError, tvlError?.message, tokenDataError?.message, reserveDataError?.message].filter(Boolean);
